# castscript Phase 6b — Voice — Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-04-castscript-design.md` — especially §7.1, §7.1.2 and §7.1.3.
...
5. `castscript doctor` explains how to enable voice, and does not fail when
