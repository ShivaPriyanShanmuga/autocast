# autocast Phase 5b — Animated and automatic zoom — Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-04-autocast-design.md` — especially §4.5, §5 and §7.2.
...
async function session() {
  const dir = mkdtempSync(join(tmpdir(), 'autocast-zoom-'));
  dirs.push(dir);
