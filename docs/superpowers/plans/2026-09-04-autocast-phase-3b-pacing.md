# autodemo Phase 3b — Transitions and idle compression — Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-04-autodemo-design.md` — especially §4.2, §7.1 and §7.2.
