# castscript Phase 6a — Captions — Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-04-castscript-design.md` — especially §7.1, §7.1.1 and §7.1.2.
...
5. `castscript validate` warns when narration cannot fit in two caption lines.
