# autocast Phase 2b — Browser rendering — Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-04-autocast-design.md` — especially §4.2, §4.4, §4.5.1, §7.2 and §13.
...
- `autocast render fixtures/browser/demo.yaml` writes a playable h264 / yuv420p 1280x720 mp4 and exits 0.
